...
class RequirementSet(object):
    ...
    def __init__(self, require_hashes=False, check_supported_wheels=True):
        ...
        self.requirements = OrderedDict()  # type: Dict[str,
        # InstallRequirement]  # noqa: E501
    ...
    def add_requirement(
        ...
        # type: (...) -> Tuple[List[InstallRequirement], Optional[
        # InstallRequirement]]  # noqa: E501
    ...
    def has_requirement(self, project_name):
        ...
        if (name in self.requirements and
                ...
                not self.requirements[
                    self.requirement_aliases[name]].constraint):
            return True
        return False
