...
class Command(object):
    ...
    def main(self, args):
        ...
        if sys.version_info[:2] == (3, 4):
            deprecated(
                    "Python 3.4 support has been deprecated. pip 19.1 will be "
                    "the "
                    "last one supporting it. Please upgrade your Python as "
                    "Python "
            ...
            if platform.python_implementation() == "CPython":
                message = (
                              "Python 2.7 will reach the end of its life on "
                              "January "
                              "1st, 2020. Please upgrade your Python as "
                              "Python 2.7 "
...
class RequirementCommand(Command):
    ...
    def _build_package_finder(
        ...
        if options.no_index:
            logger.debug(
                    'Ignoring indexes: %s',
                    ','.join(redact_password_from_url(url) for url in
                             index_urls),
            )
            index_urls = []
